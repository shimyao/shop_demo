...
public class Order {
     ...
     *
     * @param paynentType the value for neuedu_order.paynent_type
     *
     * @mbg.generated
     */
    public void setPaynentType(Integer paynentType) {
        this.paynentType = paynentType;
    }
